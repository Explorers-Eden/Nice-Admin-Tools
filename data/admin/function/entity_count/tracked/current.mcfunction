...
execute store result storage eden:temp admin.tracked_count.pos_x int 1 run data get entity @s Pos[0]
execute store result storage eden:temp admin.tracked_count.pos_y int 1 run data get entity @s Pos[1]
execute store result storage eden:temp admin.tracked_count.pos_z int 1 run data get entity @s Pos[2]
data modify storage eden:temp admin.tracked_count.pos_dimension set from entity @s Dimension
